...
<style>
html {
 background:url(Images/UHB.jpg) no-repeat center center fixed;
...
<body>
	<h2 style = "color : black; font-family: Times New Roman, Times, serif;">User Page</h2>
...
<center>
    <table   border = 4>
    <tr ><th style = "font-size: 30px; color:#000000">SubServiceTypeName</th><th style = "font-size: 30px; color:#000000">Description</th><th style = "font-size: 30px; color:#000000">Date</th><th>ViewBids</th></tr>
    
    <c:forEach items = "${worksList}" var= "work">
    	<tr border = 2><td style = "font-size: 30px; color:#000000">${work.subServiceType.name}</td><td style = "font-size: 30px; color:#000000">${work.description}</td><td style = "font-size: 30px; color:#000000">${work.date}</td>
